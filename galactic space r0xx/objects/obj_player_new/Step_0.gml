...
//get image_angle to angle_dest
//image_angle = lerp(image_angle,angle_dest,0.1);
turn = -1;

if(abs(image_angle - angle_dest) < abs(image_angle - (angle_dest-360)))
{
	turn = 1;
	//increase image_angle
	turn_current = (image_angle - angle_dest)*turn_lerp;
	image_angle += turn_current;
}
else
{
	//decrease image_angle
	turn_current = ((360-angle_dest) - image_angle)*turn_lerp;
	image_angle -= turn_current;
}
...
//recoil
var _angles_to_turn = turn_current;	//splitting the var into two to be able to 
